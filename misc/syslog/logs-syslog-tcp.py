...
import requests,time,datetime,urllib.parse,hashlib,signal,sys,math
import math
# local config
...
handler = logging.handlers.SysLogHandler(address=('haproxy',5514),socktype=socket.SOCK_STREAM)
